...
(function (factory) {
         ...
         *
         * At first, the plugin load_node() detects if the node already downloaded. If is - uses the core.data setting, if not - uses parentsload.data setting
                ...
                this.patch_data = function(){
                        ...
                        var patchSettingsProperty = function (propertyName) {
                                ...
                                if (property) {
                                        ...
                                        use jstree the same data[propertyName] setting
                                }*/
                        }
