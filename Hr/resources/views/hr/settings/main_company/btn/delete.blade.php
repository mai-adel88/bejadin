...
<a class="btn btn-danger waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ \Illuminate\Support\Facades\URL::route('mainCompany.destroy', $ID_NO) }}" data-id="{{$ID_NO}}" data-target="#custom-width-modal"><i class="fa fa-trash"></i></a>
