    ...
    public function store(Request $request){
        ...
        foreach ($requests as $key => $r){
            ...
            if ($operation->id == 4){
                ...
                $tree = supplier::where('id',$r['tree'])->first()['tree_id'];
            }elseif ($operation->id == 2){
                $tree = subscription::where('id',$r['tree'])->first()['tree_id'];
            }elseif ($operation->id == 3){
                $tree = Project::where('id',$r['tree'])->first()['tree_id'];
            }elseif ($operation->id == 5){
                $tree = employee::where('id',$r['tree'])->first()['tree_id'];
            }elseif ($operation->id == 10){
                $tree = Contractors::where('id',$r['tree'])->first()['tree_id'];
            }
