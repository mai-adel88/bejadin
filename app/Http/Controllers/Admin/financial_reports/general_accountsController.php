        ...
        if ($but_level_check){
            switch ($radiodepartment) {
                case '1';
                    ...
                    $pdf = PDF::loadView('admin.financial_reports.general_accounts.trial_balance.pdf.branches.department_total',
                ...
                case '2';
                    ...
                    $pdf = PDF::loadView('admin.financial_reports.general_accounts.trial_balance.pdf.branches.balance_account',
                        ['data'=>$data,'from' => $from,'to' => $to],[],$config);
                    return $pdf->stream();
                ...
                case '3';
                    ...
                    $pdf = PDF::loadView('admin.financial_reports.general_accounts.trial_balance.pdf.branches.debit_account',
                        ['data'=>$data,'from' => $from,'to' => $to],[],$config);
                    return $pdf->stream();
                ...
                case '4';
                    ...
                    $pdf = PDF::loadView('admin.financial_reports.general_accounts.trial_balance.pdf.branches.credit_account',
                        ['data'=>$data,'from' => $from,'to' => $to],[],$config);
                    return $pdf->stream();
...
//dd($data);
                    ...
                    $pdf = PDF::loadView('admin.financial_reports.general_accounts.trial_balance.pdf.levels.balance_account',
                        ['data'=>$data,'from' => $from,'to' => $to],[],$config);
                    return $pdf->stream();
                    /*****/
                ...
                case '3';
                    ...
                    $pdf = PDF::loadView('admin.financial_reports.general_accounts.trial_balance.pdf.levels.debit_account',
                        ['data'=>$data,'from' => $from,'to' => $to],[],$config);
                    return $pdf->stream();
                    /*****/
                ...
                case '4';
                    ...
                    $pdf = PDF::loadView('admin.financial_reports.general_accounts.trial_balance.pdf.levels.credit_account',
                        ['data'=>$data,'from' => $from,'to' => $to],[],$config);
                    return $pdf->stream();
