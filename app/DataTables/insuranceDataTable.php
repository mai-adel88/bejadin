...
class insuranceDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($query) {
                return '<a href="insurances/'.$query->id.'/edit" class="btn btn-success edit"><i class="fa fa-edit"></i> ' . trans('admin.edit') .'</a>';
            })
            ->addColumn('delete', 'admin.insurance.btn.delete')
            ->rawColumns([
                'edit',
                'delete'
            ]);
    ...
    {
        return insurance::query()->orderByDesc('id');
    }
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons' => [
                            [
                                'text' => '<i class="fa fa-plus"></i> ' . trans('admin.Add_New_Insurance'),
                                'className' => 'btn btn-primary create',
                                'action' => 'function( e, dt, button, config){ 
                                                     window.location = "insurances/create";
                                                 }',
                            ],[
                                'text' => '<i class="fa fa-bus"></i> ' . trans('admin.Buses'),
