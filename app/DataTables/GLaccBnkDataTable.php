...
class GLaccBnkDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('details', function ($query) {
                return '<a href="accbanks/'.$query->ID_No.'" class="btn btn-info"><i class="fa fa-search"></i></a>';
            })
            ->addColumn('edit', function ($query) {
                return '<a  href="accbanks/'.$query->ID_No.'/edit" class="btn btn-success edit"><i class="fa fa-edit"></i></a>';
            })
            ->addColumn('delete', 'admin.setting.accbank.btn.delete')
            ->rawColumns([
                'edit',
                'details',
                'delete',
    ...
    {
        return GLaccBnk::query()->orderByDesc('ID_No');
    }
...
//                    ->parameters($this->getBuilderParameters());
                ...
                'buttons' => [
                    [
                        ...
                        'action' => 'function( e, dt, button, config){
                             window.location = "accbanks/create";
                         }',
                    ],
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name'=>'Acc_NmAr','data'=>'Acc_Nm'.ucfirst(session('lang')),'title'=>trans('admin.arabic_name')],
