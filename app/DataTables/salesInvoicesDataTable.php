...
class salesInvoicesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($query) {
                return '<a href="salesInvoices/'.$query->Doc_No.'/edit" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>';
            })
            ...
            ->addColumn('status', function ($query) {
                return $query->status == 0?"<span class='btn btn-danger btn-sm'>".trans('admin.delete')."</span>":"<span class='btn btn-success btn-sm'>".trans('admin.active')."</span>";
            })
            ->addColumn('print', function ($query) {
                return '<a href="salesInvoices/print/'.$query->Doc_No.'" class="btn btn-info btn-sm" target="_blanck">' .'<i class="fa fa-print"></i>'  . '</a>';
            })
    ...
    {
        return InvLodhdr::with('customer')->where('Doc_Ty', 13);
    }
