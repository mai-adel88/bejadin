                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    <fieldset id="tableFilter">
                                        ...
                                        <!-- عملاء -->
                                        <div class="row">
                                            <input {{$HrAstPlcLicns->cty_client == 1 ? "checked" : "" }} id="cty_client" type="checkbox" value="1" name="cty_client" class="cty_client col-md-2 radio-inline">
                                            <label FOR="cty_client" class="col-md-10 p-0">{{trans('hr.cty_client')}}</label>
                                        </div>
                                        <!-- اقامة -->
                                        <div class="row">
                                            <input {{$HrAstPlcLicns->cty_resident == 1 ? 'checked' : '' }} id="cty_resident" type="checkbox" value="1" name="cty_resident" class="cty_resident col-md-2 radio-inline">
                                            <label FOR="cty_resident" class="col-md-10 p-0">{{trans('hr.cty_resident')}}</label>
                                        </div>
                                        <!-- رخصة القيادة-->
                                        <div class="row">
                                            <input {{$HrAstPlcLicns->cty_drivlic == 1 ? 'checked' : '' }} id="cty_drivlic" type="checkbox" value="1" name="cty_drivlic" class="cty_drivlic col-md-2 radio-inline">
                                            <label FOR="cty_drivlic" class="col-md-10 p-0 fs-13">{{trans('hr.cty_drivlic')}}</label>
                                        </div>
                                        <!-- رخصة مزاولة المهنة -->
                                        <div class="row">
                                            <input {{$HrAstPlcLicns->cty_jobactv == 1 ? 'checked' : '' }} id="cty_jobactv" type="checkbox" value="1" name="cty_jobactv" class="cty_jobactv col-md-2 radio-inline">
                                            <label FOR="cty_jobactv" class="col-md-10 p-0">{{trans('hr.cty_jobactv')}}</label>
                                        </div>
                                        <!-- هوية وطنية -->
                                        <div class="row">
                                            <input {{$HrAstPlcLicns->cty_Nat_id == 1 ? 'checked' : '' }} id="cty_Nat_id" type="checkbox" value="1" name="cty_Nat_id" class="cty_Nat_id col-md-2 radio-inline">
                                            <label FOR="cty_Nat_id" class="col-md-10 p-0">{{trans('hr.cty_Nat_id')}}</label>
                                        </div>
                                        <!-- العنوان -->
                                        <div class="row">
                                            <input {{$HrAstPlcLicns->cty_address == 1 ? 'checked' : '' }} id="cty_address" type="checkbox" value="1" name="cty_address" class="cty_address col-md-2 radio-inline">
