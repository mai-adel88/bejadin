...
@section('content')
    ...
    @push('js')
        <script>
            ...
            //         if($('.Curncy_No').val() !== ''){
            //             $.ajax({
            //                 url: "{{route('returnPurchasesExchangeRate')}}",
            //                 type: 'get',
            //                 dataType: 'json',
            //                 data:{
            ...
            //                 },
            //                 success: function (data) {
            //                     $('.ExchangeRate').val(data.Exchange)
            //                 }
            //             });
            //         }
            //     });
                ...
                // Create header
                $('.Cmp_No, .Actvty_No, .Brn_No, .Slm_No, .Cstm_No, .Dlv_Stor, .Doc_Dt, .Doc_DtAr, .SubCstm_Filno, .Pym_No, .Credit_Days, .Pym_Dt, .Notes, .Notes1, .Tax_Allow, .ExchangeRate').change(function () {
                ...
                <!-- currency -->
                    <!-- <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="Curncy_No" id="Curncy_No" class="form-control Curncy_No">
                                
                            @foreach($currencies as $currency)
                                    <option name="Curncy_No" value="{{$header->Curncy_Rate}}" data-currency-rate="{{$currency->Curncy_Rate}}">{{$currency->{'Curncy_Nm'.ucfirst(session('lang'))} }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input value="{{$header->ExchangeRate}}" type="text" name="ExchangeRate" class="form-control ExchangeRate" id="ExchangeRate" readonly style="background: #fff">
                        </div>
                    </div> -->
                <!-- currency -->
                            ...
                            @if(count($header->details) > 0)
                                @foreach($header->details as $detail)
                                    <tr>
                                        ...
                                        <td><input type="number" min="1" name="Itm_Pur" id="Itm_Pur_{{$detail->Ln_No}}" class="Itm_Pur" value="{{$detail->Itm_Pur}}"></td>
