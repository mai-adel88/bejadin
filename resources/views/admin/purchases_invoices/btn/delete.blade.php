...
<a class="btn btn-danger waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ \Illuminate\Support\Facades\URL::route('purchasesInvoices.destroy', $Doc_No) }}" data-id="{{$Doc_No}}" data-target="#custom-width-modal"><i class="fa fa-trash"></i></a>
