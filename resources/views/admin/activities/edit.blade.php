...
@section('content')
    ...
    <form action="{{route('activities.update', $act->ID_No)}}" method="POST">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        <div class="panel panel-primary" style="width:50%; margin:auto auto;    ">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <input type="text" name="Actvty_No" id="Actvty_No" class="form-control col-md-2" readonly value="{{$act->Actvty_No}}">
                </div>
                {{-- نهاية رقم النشاط --}}
                {{-- اسم الحساب عربى --}}
                <div class="row">
                    ...
                    <input type="text" name="Name_Ar" id="Name_Ar" class="form-control col-md-9" value="{{$act->Name_Ar}}">
                </div>
                ...
                <div class="row">
                    ...
                    <input type="text" name="Name_En" id="Name_En" class="form-control col-md-9" value="{{$act->Name_En}}">
                </div>
