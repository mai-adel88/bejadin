@extends('admin.index')
@section('title',trans('admin.edit_contractor'))
@section('content')
    @push('js')
...
@can('create')
    <div class="box">
        ...
        <div class="box-header">
            <h3 class="box-title">{{trans('admin.edit_contractor')}}</h3>
        </div>
        <div class="box-body">
            ...
            <div class="form-group row">
                <div class="col-md-3">
                    ...
                    {{ Form::select('section_id',$branches, $contract->section_id, array_merge(['class' => 'form-control','placeholder'=>trans('admin.select')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('date', $contract->data, array_merge(['class' => 'form-control datepicker','id' => 'history_date','placeholder'=>trans('admin.date')])) }}
                    @if ($errors->has('date'))
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::hidden('higri_date', $contract->higri_date, array_merge(['class' => 'form-control higri_date','placeholder'=>trans('admin.higri_date')])) }}
                    {{ Form::text('higri_datee', $contract->higri_date, array_merge(['class' => 'form-control higri_date','disabled' => 'disabled','placeholder'=>trans('admin.higri_date')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::select('project_id',$project,$contract->project_id, array_merge(['class' => 'form-control','placeholder'=>trans('admin.select')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-3">
                    ...
                    {{ Form::select('contractor_id',$contractors,$contract->contractor_id, array_merge(['class' => 'form-control','placeholder'=>trans('admin.select')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('Contract_reference', $contract->Contract_reference, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Reference_for_contracting')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('contract_number', $contract->contract_number, array_merge(['class' => 'form-control','placeholder'=>trans('admin.contract_number')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::select('subscriber_id',$subscription,$contract->subscriber_id, array_merge(['class' => 'form-control','placeholder'=>trans('admin.select')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    {{ Form::text('statement_ar', $contract->statement_ar, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Statement_ar')])) }}
                ...
                <div class="col-md-6">
                    ...
                    {{ Form::text('statement_en', $contract->statement_en, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Statement_en')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-3">
                    ...
                    {{ Form::text('contract_date', $contract->contract_date, array_merge(['class' => 'form-control datepicker','placeholder'=>trans('admin.Date_of_contract')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('contract_start', $contract->contract_start, array_merge(['class' => 'form-control datepicker','id' => 'contract_start','placeholder'=>trans('admin.The_beginning_of_the_contract')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('contract_end', $contract->contract_end, array_merge(['class' => 'form-control datepicker','placeholder'=>trans('admin.End_of_contract')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('contract_period', $contract->contract_period, array_merge(['class' => 'form-control','id' => 'contract_period','placeholder'=>trans('admin.Contract_Period')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-3">
                    ...
                    {{ Form::text('implementation_start', $contract->implementation_start, array_merge(['class' => 'form-control datepicker','placeholder'=>trans('admin.Start_of_implementation')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('implementation_end', $contract->implementation_end, array_merge(['class' => 'form-control datepicker','placeholder'=>trans('admin.End_of_implementation')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('warranty_start', $contract->warranty_start, array_merge(['class' => 'form-control datepicker','placeholder'=>trans('admin.The_beginning_of_the_warranty')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('warranty_end', $contract->warranty_end, array_merge(['class' => 'form-control datepicker','placeholder'=>trans('admin.End_of_warranty')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-3">
                    ...
                    {{ Form::number('employees_number', $contract->employees_number, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Number_of_Employees')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('employee_hour_work', $contract->employee_hour_work, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Working_hours_of_the_employee')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('months_number', $contract->months_number, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Number_of_months')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('monthly_payment', $contract->monthly_payment, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Monthly_payment')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    {{ Form::number('contract_value', $contract->contract_value, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Contract_Value')])) }}
                ...
                <div class="col-md-4">
                    ...
                    {{ Form::number('estimated_value', $contract->estimated_value, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Estimated_Value')])) }}
                ...
                <div class="col-md-4">
                    ...
                    {{ Form::number('deviation_value', $contract->deviation_value, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Deviation_value')])) }}
                ...
                {{--  <div class="col-md-3">
                    ...
                    {{ Form::number('deviation_value_pc', $contract->deviation_value_pc, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Percentage_deviation_value')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    {{ Form::number('downpayment', $contract->downpayment, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Downpayment')])) }}
                ...
                <div class="col-md-4">
                    ...
                    {{ Form::number('warranty_expenses', $contract->warranty_expenses, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Warranty_expenses')])) }}
                ...
                <div class="col-md-4">
                    ...
                    {{ Form::number('insurance_value', $contract->insurance_value, array_merge(['class' => 'form-control','placeholder'=>trans('admin.insurance_value')])) }}
            ...
            <div class="form-group row">
                <div class="col-md-3">
                    ...
                    {{ Form::number('contract_value_customer', $contract->contract_value_customer, array_merge(['class' => 'form-control','placeholder'=>trans('admin.The_contract_value_of_the_customer')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('subcontracts_value', $contract->subcontracts_value, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Value_of_Subcontracts')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('total_payments', $contract->total_payments, array_merge(['class' => 'form-control','placeholder'=>trans('admin.Total_Payments')])) }}
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::number('current_balance', $contract->current_balance, array_merge(['class' => 'form-control','placeholder'=>trans('admin.current_balance')])) }}
                    @if ($errors->has('current_balance'))
                        <div class="alert alert-danger" style="margin-top: 10px">{{ $errors->first('current_balance') }}</div>
                    @endif
                </div>
            </div>
            {{Form::submit(trans('admin.edit_contractor'),['class'=>'btn btn-primary'])}}
            {!! Form::close() !!}
        </div>
    </div>
    @endcan
