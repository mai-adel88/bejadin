                ...
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            ...
                            <td>{{round($data->sum('creditor') + $data->sum('debtor'))}} {{trans('admin.EGP')}}</td>
                        </tr>
                        <tr>
                            <th>{{trans('admin.payment')}}:</th>
                            <td>{{round($receiptsData->debtor)}} {{trans('admin.EGP')}}</td>
                        </tr>
                        <tr>
                            <th>{{trans('admin.subtract')}}:</th>
                            <td>{{round(($data->sum('creditor') + $data->sum('debtor')) - $receiptsData->debtor)}} {{trans('admin.EGP')}}</td>
                        </tr>
                    </table>
                </div>
            </div>
