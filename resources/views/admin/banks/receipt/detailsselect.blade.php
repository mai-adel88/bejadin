        ...
        $('#add_data').on('click',function () {
            ...
            var receipts = '{{$receipts}}';
                $.ajax({
                    ...
                    type:'get',
                    dataType:'html',
                    data:{cc: cc,percentage: percentage,discount: discount,type: type,add : add,invoice:invoice,note_debt: note_debt,total: total,operation: operation,tree: tree,receipts: receipts},
...
<div class="form-group row">
    <div class="col-md-3">
        ...
        <input type="text" name="price" onkeyup="calculatePrice()" class="form-control" required="required">
    </div>
    <div class="col-md-3">
...
<div class="form-group">
    {{ Form::label('note_debt', trans('admin.note_for'), ['class' => 'control-label']) }}
    {{ Form::text('note_debt',null, array_merge(['class' => 'form-control note_credit' ])) }}
</div>
...
<br>
<div class="form-group">
    {{ Form::label('fundsBanks', trans('admin.credit_account'), ['class' => 'control-label']) }}
    <select name="fundsBanks" class="form-control e2" placeholder="{{trans('admin.select')}}" required="required">
        <option></option>
...
<div class="form-group row">
    <div class="col-md-4">
        ...
        <input type="text" name="creditor" onkeyup="calculatedept()" class="form-control creditor" value="{{$data->sum('creditor')}}">
    </div>
    <div class="col-md-4">
        {{ Form::label('debtor', trans('admin.debtor'), ['class' => 'control-label']) }}
        <input type="text" name="debtor" onkeyup="calculatedept()" class="form-control creditor" disabled="disabled" value="{{$data->sum('debtor')}}">
    </div>
    <div class="col-md-4">
...
<div class="form-group">
    ...
    {{ Form::text('note_credit',null, array_merge(['class' => 'form-control note_debt' ])) }}
</div>