                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td colspan="3">{{$data->sum('debtor')}}</td>
                        </tr>
                        <tr>
                            <td colspan="2"><strong>{{trans('admin.total_motion_creditor')}}</strong></td>
                            <td colspan="2">{{$data->sum('creditor')}}</td>
                        </tr>
                        </tbody>
    ...
    <div class="row no-print" style="margin: 10px 25px">
        <div class="col-xs-12">
            <ul class="list-inline">
                <li>
                    {!! Form::open(array('url' => 'admin/openingentrydata/invoice/print/' . $limitations->id, 'method' => 'POST', 'target' => '_blank')) !!}
