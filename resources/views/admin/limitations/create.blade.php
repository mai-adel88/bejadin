        ...
        <script>
            $(document).ready(function(){
                ...
                $('#save').click(function(e){
                    ...
                    $.ajax({
                        url: "{{route('limitationOperation.store')}}",
                        type: "post",
                        dataType: 'html',
                        data: {
                            "_token": "{{ csrf_token() }}",
            ...
            <div class="panel-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" value="{{$GLAstJrntyp?$GLAstJrntyp->{'Jrty_Nm'.ucfirst(session('lang'))}: 'لا يوجد' }}" readonly>
                            <input type="hidden" id="Jr_Ty" name="Jr_Ty" class="Jr_Ty" value="{{$GLAstJrntyp?$GLAstJrntyp->Jr_Ty: ''}}">
                        </div>
                    </div>
                    {{-- نهاية نوع القيد --}}
