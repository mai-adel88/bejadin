        ...
        $(function () {
            ...
            $(document).on('click','#save:not(.clicked)',function () {
                ...
                if($('#save').data('clicked')) {
                    $.ajax({
                        url: '{{aurl('limitationsData/invoice/invoice')}}',
                        type:'get',
                        dataType:'html',
...
<div id="invoice">
    <section class="invoice">
        <h2 class="title text-center">
            {{\App\Enums\dataLinks\LimitationsType::getDescription($limitationType)}}
        </h2>
        <!-- title row -->
    ...
    <div class="col-xs-12">
        <ul class="list-inline">
            ...
            <li>
                ...
                {!! Form::open(array('url' => 'admin/limitationsData/invoice/pdf/' . $limitation->id, 'method' => 'POST', 'target' => '_blank', 'id' => 'print')) !!}
            ...
            <li>
                {!! Form::open(array('url' => 'admin/limitationsData/invoice/print/' . $limitation->id, 'method' => 'POST', 'target' => '_blank','style'=>'display:none', 'id' => 'saveprint')) !!}
