...
{{--            @if(($merged->Fbal_DB  +  Fbalance($merged->Cmp_No,$merged->Acc_No,$from,$to,'Tr_Db','<') ) > 0 ||--}}
{{--                ($merged->Fbal_CR + Fbalance($merged->Cmp_No,$merged->Acc_No,$from,$to,'Tr_Cr','<') )  > 0 ||--}}
{{--                (getTrans($merged->Cmp_No,$merged->Acc_No,$from,$to,'Tr_Db','>=')) > 0 ||--}}
{{--                (getTrans($merged->Cmp_No,$merged->Acc_No,$from,$to,'Tr_Cr','>=')) > 0 )--}}
