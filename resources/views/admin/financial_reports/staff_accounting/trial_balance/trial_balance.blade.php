@extends('admin.index')
@section('title', trans('admin.trial_balance_sup'))
@section('content')
    @push('css')
        <style>
            ...
            $(function () {
                ...
                $('#MainCompany').on('change',function () {
                    ...
                    if (this){
                        ...
                        $.ajax({
                            url: '{{route('trialbalanceSup.show')}}',
                            type:'get',
                            dataType:'html',
                            data:{MainCompany:MainCompany},
                            success: function (data) {
            ...
            <div class="col-md-6 col-xs-12 well well-sm">
                <div class="col-xs-12">
                    <div class="col-xs-6">
                        ...
                        {{ Form::text('From',\Carbon\Carbon::today()->format('Y-'.\Carbon\Carbon::now()->diffInYears(\Carbon\Carbon::now()->copy()->addYear()).'-'.\Carbon\Carbon::now()->diffInYears(\Carbon\Carbon::now()->copy()->addYear())), array_merge(['class' => 'col-md-10 col-xs-9 form-control  hijri-date-input','id'=>'toDate','autocomplete'=>'off'])) }}
                    </div>
                    <div class="col-xs-6">
