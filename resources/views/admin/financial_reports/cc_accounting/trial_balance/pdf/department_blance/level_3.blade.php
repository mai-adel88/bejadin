...
<div class="table-responsive">
    <table style="border: none" class="table table-bordered table-striped table-hover text-center">
        ...
        @foreach($data as $merged)
            @if((($merged->Level_Status == '0') && ($merged->Fbal_DB + CC_Trial_Balance_Fbalance($merged->ID_No,$merged->Cmp_No,$merged->Acc_No,$from,$to,'Tr_Db','<') ) > 0 ||  CC_Trial_Balance_getTrans($merged->ID_No,$merged->Cmp_No,$merged->Costcntr_No,$from,$to,'Tr_Db','>=') > 0   )
             ||
              (($merged->Level_Status == '1') && ($merged->Fbal_DB  + CC_Trial_Balance_One_Fbalance($merged->ID_No,$merged->Cmp_No,$merged->Costcntr_No,$from,$to,'Tr_Db','<')) > 0 ||  CC_Trial_Balance_One_gettrans($merged->ID_No,$merged->Cmp_No,$merged->Costcntr_No,$from,$to,'Tr_Db','>=') >0 ))
