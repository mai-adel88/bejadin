            ...
            @can('single')
                ...
                <div class="form-group row col-md-12">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-11" style="margin-bottom: 10px;right: 27px;">{!!Form::text('Slm_NmAr', null, ['class'=>'form-control', 'readonly'=>'true'])!!}</div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-1" style="margin-right: -47px;left: -18px;">{!!Form::label('Slm_NmEn', trans('admin.subscriber_name_en'))!!}</div>
                        <div class="col-md-11" style="margin-bottom: 10px;right: 27px;">{!!Form::text('Slm_NmEn', null, ['class'=>'form-control', 'readonly'=>'true'])!!}</div>
                    </div>
                </div>
