        ...
        <div class="panel panel-primary" style="width:50%; margin:auto auto;">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <input type="text" name="Acc_No" id="Acc_No" class="form-control col-md-3" value="{{$bank->Acc_No}}">
                ...
                <div class="row">
                    ...
                    <input type="text" name="Acc_NmAr" id="Acc_NmAr" class="form-control col-md-9" value="{{$bank->Acc_NmAr}}">
                </div>
                ...
                <div class="row">
                    ...
                    <input type="text" name="Acc_NmEn" id="Acc_NmEn" class="form-control col-md-9" value="{{$bank->Acc_NmEn}}">
                </div>
                ...
                <div class="row">
                    ...
                    <input type="text" name="Acc_Bank_No" id="Acc_Bank_No" class="form-control col-md-4" value="{{$bank->Acc_Bank_No}}">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            {{-- سند قبض نقدى --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="RcpCsh_Voucher" id="RcpCsh_Voucher" @if($bank->RcpCsh_Voucher == 1) checked @endif>
                                <label for="RcpCsh_Voucher">{{trans('admin.RcpCsh_Voucher')}}</label>
                            </div>
                            {{-- نهاية سند قبض نقدى --}}
                            {{-- سند صرف نقدى --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="PymCsh_voucher" id="PymCsh_voucher" @if($bank->PymCsh_voucher == 1) checked @endif>
                                <label for="PymCsh_voucher">{{trans('admin.cash_payment')}}</label>
                            </div>
                            {{-- نهاية سند صرف نقدى --}}
                            {{-- اشعار مدين --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="DB_Note" id="DB_Note" @if($bank->DB_Note == 1) checked @endif>
                                <label for="DB_Note">{{trans('admin.debt_notify')}}</label>
                            </div>
                            {{-- نهاية اشعار مدين --}}
                            {{-- سند قبض شيك --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="RcpChk_Voucher" id="RcpChk_Voucher" @if($bank->RcpChk_Voucher == 1) checked @endif>
                                <label for="RcpChk_Voucher">{{trans('admin.RcpChk_Voucher')}}</label>
                            </div>
                            {{-- نهاية سند قبض شيك --}}
                            {{-- سند صرف شيك --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="PymChk_Voucher" id="PymChk_Voucher" @if($bank->PymChk_Voucher == 1) checked @endif>
                                <label for="PymChk_Voucher">{{trans('admin.cheque_payment')}}</label>
                            </div>
                            {{-- نهاية سند صرف شيك --}}
                            {{-- اشعار دائن --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="CR_Note" id="CR_Note" @if($bank->CR_Note == 1) checked @endif>
                                <label for="CR_Note">{{trans('admin.credit_notify')}}</label>
                            </div>
                            {{-- نهاية اشعار دائن --}}
                            {{-- مجمع النقديه --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="Cash_Rpt" id="Cash_Rpt" @if($bank->Cash_Rpt == 1) checked @endif>
                                <label for="Cash_Rpt">{{trans('admin.Cash_Rpt')}}</label>
                            </div>
                            {{-- نهاية مجمع النقديه --}}
                            {{-- البنوك  --}}
                            <div class="col-md-4">
                                <input type="checkbox" name="Bank_No" id="Bank_No" @if($bank->Bank_No == 1) checked @endif>
