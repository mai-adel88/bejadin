<script>
    $(document).ready(function(){
        ...
        $('.remove-record').click(function() {
            ...
            $('body').find('.remove-record-model').append('<input name="ID_No" type="hidden" value="'+ id +'">');
        });
...
<a class="btn btn-danger waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ \Illuminate\Support\Facades\URL::route('employees.destroy', $ID_No) }}" data-id="{{$ID_No}}" data-target="#custom-width-modal"><i class="fa fa-trash"></i></a>
