...
@section('content')
    ...
    <!--Blog blog post -->
    <div id="blogs" class="bg-white timeline-blog section-ptb-100 sm-pb-50 sm-pt-50">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <ul class="timeline">
                        ...
                        <li>
                            <div class="timeline-badge primary">
                                <a href="#">{{ date('j', strtotime($blog->publish_after)) }}</a>
                                <span>{{ date('M', strtotime($blog->publish_after)) }}</span>
                            </div>
                                ...
                                <div class="blog-post">
                                    ...
                                    <div class="blog-detail">
                                        ...
                                        <div class="entry-content">
                                            <p>{{ substr(strip_tags($blog->content), 0, 250) }} {{ strlen(strip_tags($blog->content)) > 250 ? "...." : "" }}</p>
                                        </div>
                                        <div class="entry-share clearfix">
                                            <div class="btn btn-primary">
                                                <a style="color: #fff;" href="{{ url('blog/' . $blog->id) }}"> Read More <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
