    ...
    <div>
        <div class="box limitations">
            <div class="box-header">
                <h3 class="box-title">اضافة قيد جديد</h3>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select v-model="form.limitations" name="limitations" class="form-control" :class="{ 'is-invalid': form.errors.has('limitations') }" @change="limitationschange">
                                <option value="" selected>{{ trans('admin.select') }}</option>
                                <option v-if="branchselect" v-for="limitation in limitations[0]" :value="limitation.id">{{limitation.name_ar}}</option>
                            </select>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            login(){
                this.$Progress.start();
                axios.post('/api/admin/limitations/store',this.infos).then(response => {
        ...
        created(){
            ...
            axios.get('/api/admin/limitations/debt').then(response => {
                this.limitations = response.data
            });
            axios.get('/api/admin/limitations').then(response => {
